...
export default function Result({ url, initialValue }: InitialValue) {
    return (
        <li className="rounded-xl p-4 mb-4 bg-white transition-transform hover:shadow hover:shadow-grey-500 hover:scale-102">
            ...
            <code className="inline-block bg-gray-300 font-black rounded-lg mb-2 px-2 cursor-pointer transition-transform hover:outline hover:outline-gray-600">{getPropertyName(url)}: {initialValue};</code>
