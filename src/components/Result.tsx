...
export default function Result({ url, initialValue }: InitialValue) {
    return (
        <li className="rounded-md p-4 mb-4 bg-white transition-transform hover:shadow hover:shadow-grey-500 hover:scale-102">
            ...
            <small className="block text-gray-900 p-1">Read more at <a className="text-orange-600 underline underline-offset-1 hover:no-underline" href={url} target="_blank">MDN Web Docs</a></small>
        </li>
    );
}